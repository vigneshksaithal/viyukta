...
class CommitmentProto extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CommitmentProto', createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commitmentRequestNumber', protoName: 'commitmentRequestNumber')
  ...
  factory CommitmentProto({
    $core.String? commitmentRequestNumber,
    $core.String? date,
    $core.String? type,
    $core.double? amount,
  }) {
    final _result = create();
    if (commitmentRequestNumber != null) {
      _result.commitmentRequestNumber = commitmentRequestNumber;
    }
    if (date != null) {
      _result.date = date;
    }
  ...
  @$pb.TagNumber(1)
  $core.String get commitmentRequestNumber => $_getSZ(0);
  @$pb.TagNumber(1)
  set commitmentRequestNumber($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasCommitmentRequestNumber() => $_has(0);
  @$pb.TagNumber(1)
  void clearCommitmentRequestNumber() => clearField(1);
